...
<div class="imgAndInfo">
    ...
    <div class="imgInimgAndInfo">
        <img src="img/productImage/${p.firstProductImage.id}.jpg" class="bigImg">
        <div class="smallImageDiv">
            <c:forEach items="${p.productSingleImages}" var="pi">
                <img src="img/productImage/${pi.id}.jpg" bigImageURL="img/productImage/${pi.id}.jpg" class="smallImage">
            </c:forEach>
        </div>
    ...
    <div class="infoInimgAndInfo">
        ...
        <div class="productPrice">
            ...
            <div class="productPriceDiv">
                <div class="gouwujuanDiv"><img height="16px" src="image/site/gouwujuan.png">
                <span> 全天猫实物商品通用</span>
